package com.example.hnew.register;
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {                //登录事件
            ...
            public void onClick(View v) {
                ...
                if (flag != 0) {                                            //若查询出的记录不为0，则进行跳转操作
                    ...
                    //intent.setClass(Login.this, MainActivity.class);            //设置页面跳转
                    ...
                    Toast.makeText(Login.this, "用户名或密码错误！", Toast.LENGTH_LONG).show();             //提示用户信息错误或没有账号
                }
